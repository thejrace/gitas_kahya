...
public class KahyaClient {
    ...
    private ArrayList<RunData> bussesWithSameDirection = new ArrayList<>(); // busses that's going to same direction with active Bus
    ...
    private Map<String, Integer> totalStopDiffs = new HashMap<>();
